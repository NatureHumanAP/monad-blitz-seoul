...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white px-6 py-10 font-sans text-zinc-900 dark:from-black dark:to-zinc-950 dark:text-zinc-50">
